...
public class JICallBuilder extends NdrObject implements Serializable {
	 ...
	 *                             not supported by the <code>IJIComObject</code> on
	 *                             which this builder would act. Use
	 *                             {@link IJIComObject#isDispatchSupported()} to
	 *                             find out if dispatch is supported on the COM
	 *                             Object.
	 */
	...
	// /**Add IN parameter as <code>JIInterfacePointer</code> at the end of the
	// Parameter list.
	// *
	// * @param value
	...
	/**
	 * Add <code>[in]</code> parameter as <code>IJIComObject</code> at the end of
	 * the Parameter list.
	 *
	 * @param comObject
	 * @param FLAGS     from JIFlags (if need be)
	 ...
	 * @param FLAGS from JIFlags (if need be)
	 */
	public void addInParamAsInt(final Integer value, final int FLAGS) {
		insertInParamAsIntAt(this.inParams.size(), value, FLAGS);
	}

	/**
	 * Add <code>[in]</code> parameter as <code>IJIUnsigned</code> at the end of the
	 * Parameter list.
	 *
	 * @param value
	 * @param FLAGS from JIFlags (if need be)
	...
	/**
	 * Add <code>[in]</code> parameter as <code>JIVariant</code> at the end of the
	 * Parameter list.
	 *
	 * @param value
	 * @param FLAGS from JIFlags (if need be).
	...
	/**
	 * Add <code>[in]</code> parameter as <code>String representation of UUID</code>
	...
	/**
	 * Add <code>[in]</code> parameter as <code>JIPointer</code> at the end of the
	 * Parameter list.
	 *
	 * @param value
	 * @param FLAGS from JIFlags (if need be).
	...
	/**
	 * Add <code>[in]</code> parameter as <code>JIStruct</code> at the end of the
	 * Parameter list.
	 *
	 * @param value
	 * @param FLAGS from JIFlags (if need be).
	...
	/**
	 * Add <code>[in]</code> parameter as <code>Object[]</code> at the end of the
	 * Parameter list.The array is iterated and all members appended to the list.
	 *
	 * @param values
	 * @param FLAGS  from JIFlags (if need be).
	 */
	...
	/**
	 * Add <code>[in]</code> parameter as <code>IJIComObject</code> at the specified
	...
	/**
	 * Add <code>[in]</code> parameter as <code>int</code> at the specified index in
	 * the Parameter list.
	 *
	 * @param index 0 based index
	 * @param value
	 * @param FLAGS from JIFlags (if need be).
	 */
	public void insertInParamAsIntAt(final int index, final Integer value, final int FLAGS) {
		this.inParams.add(index, value);
		this.inparamFlags.add(index, new Integer(FLAGS));
	}

	/**
	 * Add <code>[in]</code> parameter as <code>IJIUnsigned</code> at the specified
	 * index in the Parameter list.
	 *
	 * @param index 0 based index
	 * @param value
	...
	/**
	 * Add <code>[in]</code> parameter as <code>float</code> at the specified index
	...
	/**
	 * Add <code>[in]</code> parameter as <code>short</code> at the specified index
	 * in the Parameter list.
	 *
	 * @param index 0 based index
	 * @param value
	...
	/**
	 * Add <code>[in]</code> parameter as <code>double</code> at the specified index
	 * in the Parameter list.
	 *
	 * @param index 0 based index
	 * @param value
	...
	/**
	 * Add <code>[in]</code> parameter as <code>char</code> at the specified index
	 * in the Parameter list.
	 *
	 * @param index 0 based index
	 * @param value
	...
	/**
	 * Add <code>[in]</code> parameter as <code>String</code> at the specified index
	 * in the Parameter list.
	 *
	 * @param index 0 based index
	 * @param value
	...
	/**
	 * Add <code>[in]</code> parameter as <code>JIVariant</code> at the specified
	 * index in the Parameter list.
	 *
	 * @param index 0 based index
	 * @param value
	...
	/**
	 * Add <code>[in]</code> parameter as <code>Object</code> at the specified index
	 * in the Parameter list.
	 *
	 * @param index 0 based index
	 * @param value
	...
	/**
	 * Add <code>[in]</code> parameter as <code>JIPointer</code> at the specified
	 * index in the Parameter list.
	 *
	 * @param index 0 based index
	 * @param value
	...
	/**
	 * Removes <code>[in]</code> parameter at the specified index from the Parameter
	 * list.
	 *
	 * @param index 0 based index
	 * @param FLAGS from JIFlags (if need be).
	...
	/**
	 * Returns <code>[in]</code> parameter at the specified index from the Parameter
	 * list.
	 *
	 * @param index 0 based index
	 * @return Primitives are returned as there Derieved types.
	 */
	// Will just provide 1 getter, for outParams there would be overloads like
	// inParam setters.
	...
	/**
	 * Add <code>[out]</code> parameter of the type <code>clazz</code> at the end of
	 * the out parameter list.
	 *
	 * @param clazz
	 * @param FLAGS
	 */
	...
	/**
	 * Add <code>[out]</code> parameter as <code>Object[]</code> at the end of the
	 * Parameter list. The array is iterated and all members appended to the list.
	 *
	 * @param values
	 * @param FLAGS  from JIFlags (if need be).
	...
	/**
	 * Returns the value as <code>String representation of the UUID</code> at the
	 * index from the result list.
	 *
	 * @param index 0 based index
	 * @return
	 */
	...
	/**
	 * Returns the <code>HRESULT</code> of this operation. This should be zero for
	 * successful calls and non-zero for failures.
	 *
	 * @return
	 */
	...
	/**
	 * Returns the opnum of the API which will be invoked at the <code>COM</code>
	 * server.
	 */
	@Override
	public int getOpnum() {
	 ...
	 * <code>COM server</code> for this, all APIs are listed in a sequential order
	 * starting from 0. Please ignore the <code>"Id"</code> they might be having and
	 * count the index of the API being called here from the beginning of the
	 * interface starting from 0 as the first index. Also note that if this
	 * interface derieves from anything other than <code>IUnknown</code> or
	 * <code>IDispatch</code>, your start index will change from 0 to the
	 * cumulative(if that interface is also a derieved one) count of the super
	 * interface. For e.g if A(3 apis) derieves from B (10 apis), then first API of
	 * A is at Opnum of 3, second at 4 and so on. Alternatively, you can use the
	 * IJIDispatch interface, if the object supports it.
	 */
		...
		if (inparams != null) {
			...
			while (index < inparams.length) {
				...
				if (inparams[index] == null) {
					JIMarshalUnMarshalHelper.serialize(ndr, Integer.class, new Integer(0), listOfDefferedPointers,
							JIFlags.FLAG_NULL);
				} else {
					JIMarshalUnMarshalHelper.serialize(ndr, inparams[index].getClass(), inparams[index],
							listOfDefferedPointers, ((Integer) this.inparamFlags.get(index)).intValue());
				}

				int x = 0;

				while (x < listOfDefferedPointers.size()) {
					// thought of this today morning...change the logic here...the defeered pointers
					// need to be
					// completely serialized here. If they are also having nested deffered pointers
					// then those pointers
					...
					// current x.
					// consider the case when there is a Struct having a nested pointer to another
					// struct and this struct
					...
					// }
					//
					// while serializing this struct the pointer 1 will get deffered and so will
					// pointer 2. Now while writing
					// the deffered pointers , we will find that the pointer 1 is pointing to a
					// struct which has another deffered pointer (pointer to another struct maybe)
					// in such case, the current logic will add the deffered pointer to the end of
					// the listOfDefferedPointers list, effectively serializing it
					// after the pointer 2 referent. But that is what is against the rules of
					// DCERPC, in this case the referent of pointer 1 (struct with the pointer to
					// another struct)
					...
					JIMarshalUnMarshalHelper.serialize(ndr, JIPointer.class, listOfDefferedPointers.get(x), newList,
							((Integer) this.inparamFlags.get(index)).intValue());
	...
	private void readPacket(final NetworkDataRepresentation ndr, final boolean fromCallback) {
		...
		if (this.outparams != null && this.outparams.length > 0) {
			while (index < this.outparams.length) {
				final List listOfDefferedPointers = new ArrayList();
				results.add(JIMarshalUnMarshalHelper.deSerialize(ndr, this.outparams[index], listOfDefferedPointers,
						((Integer) this.outparamFlags.get(index)).intValue(), additionalData));
				int x = 0;
				...
				while (x < listOfDefferedPointers.size()) {
					...
					final JIPointer replacement = (JIPointer) JIMarshalUnMarshalHelper.deSerialize(ndr,
							listOfDefferedPointers.get(x), newList,
							((Integer) this.outparamFlags.get(index)).intValue(), additionalData);
					((JIPointer) listOfDefferedPointers.get(x)).replaceSelfWithNewPointer(replacement); // this should
																										// replace the
																										// value in the
																										// original
																										// place.
			...
			for (final Object comObject2 : comObjects) {
				final JIComObjectImpl comObjectImpl = (JIComObjectImpl) comObject2;
				try {
					...
					if (fromCallback) {
						...
						final JIComServer comServer = new JIComServer(newsession,
								comObjectImpl.internal_getInterfacePointer(), null);
						comObject = comServer.getInstance();
						JIFrameworkHelper.link2Sessions(this.session, newsession);
					} else {
						comObject = JIFrameworkHelper.instantiateComObject2(this.session,
								comObjectImpl.internal_getInterfacePointer());
					}
					...
					// Why did I put this here. We should do an addRef regardless of whether we give
					// a pointer to COM or it gives us one.
					// if (!fromCallback)
					{
	...
	private int bufferLength() {
		...
		for (final Object inparam : inparams) {
			...
			final int length2 = JIMarshalUnMarshalHelper.getLengthInBytes(inparam.getClass(), inparam,
					JIFlags.FLAG_NULL);
	...
	/**
	 * Returns true incase the Call resulted in an exception, use getHRESULT to get
	 * the error code.
	 *
	 * @return
	 */
