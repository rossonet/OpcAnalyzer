...
final class JIComObjectImpl implements IJIComObject
{
    ...
    public void addRef () throws JIException
    {
        ...
        {
            logger.debug ( "addRef: Adding 5 references for " + this.ptr.getIPID () + " session: " + this.session.getSessionIdentifier () );
        }
    ...
    public void release () throws JIException
    {
        ...
        if ( logger.isInfoEnabled () )
        {
            logger.debug ( "RELEASE called directly ! removing 5 references for " + this.ptr.getIPID () + " session: " + this.session.getSessionIdentifier () );
