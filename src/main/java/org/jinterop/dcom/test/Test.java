...
public class Test {
	...
	public static void main(final String[] args) {
		try {
			...
			// "itlinfosys", "vikram_roopchand", "Dilbert007" );
			//
			...
			final NtlmPasswordAuthentication mycreds = new NtlmPasswordAuthentication("itl-hw-lt15522", "TestUser",
					"Enabler2000");
			SmbSession.logon(mydomaincontoller, mycreds);
			// PLEASE NOTE THAT THE WINDOWS "SERVER" SERVICE SOULD BE RUNNING !!! OTHERWISE
			// THE
			// GETCHALLENGE WILL FAIL.
			// UniAddress mydomaincontoller =
			// UniAddress.getByName("itl-hw-lt15522.ad.infosys.com");
